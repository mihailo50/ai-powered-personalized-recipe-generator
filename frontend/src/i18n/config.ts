  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        noSearchesYet: "No searches yet. Generate a recipe to get started.",
        signInToSyncSearches: "Sign in to sync your searches.",
        failedToLoadHistory: "Failed to load history",
        savedSearch: "Saved search",
        ingredientsLabel: "Ingredients",
        myRecipes: "My recipes",
        favorites: "Favorites",
        noFavoritesYet: "No favorites yet. Save a recipe to see it here.",
        noRecipesYet: "You haven't saved any recipes yet. Generate one to get started.",
        failedToLoadRecipes: "Failed to load recipes",
        unableToUpdateFavorite: "Unable to update favorite",
        serving: "serving",
  ...
  sr: {
    translation: {
      ...
      dashboard: {
        ...
        noSearchesYet: "Još nema pretraga. Generišite recept da počnete.",
        signInToSyncSearches: "Prijavite se da sinhronizujete svoje pretrage.",
        failedToLoadHistory: "Neuspešno učitavanje istorije",
        savedSearch: "Sačuvana pretraga",
        ingredientsLabel: "Sastojci",
        myRecipes: "Moji recepti",
        favorites: "Omiljeni",
        noFavoritesYet: "Još nema omiljenih. Sačuvajte recept da ga vidite ovde.",
        noRecipesYet: "Još niste sačuvali nijedan recept. Generišite jedan da počnete.",
        failedToLoadRecipes: "Neuspešno učitavanje recepta",
        unableToUpdateFavorite: "Neuspešno ažuriranje omiljenog",
        serving: "porcija",
        servingsPlural: "porcije",
        prep: "Priprema",
        cook: "Kuvanje",
        min: "min",
        favorited: "Omiljeno",
        saveToFavorites: "Sačuvaj u omiljene",
      },
    },
  },
};
